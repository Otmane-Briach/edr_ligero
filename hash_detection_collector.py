        ...
        if points > 0:
            ...
            if hasattr(self.detector, 'process_tree') and self.detector.process_tree.tree:
                ...
                if ppid:
                    ...
                    # NUEVO: Throttling para no recalcular constantemente
                    if not hasattr(self, 'family_last_check'):
                        self.family_last_check = {}
                        
                    if family_id in self.family_last_check:
                        if event_time - self.family_last_check[family_id] < 0.5:  # Max 2/segundo
                            return None  # Salir sin recalcular
                    self.family_last_check[family_id] = event_time
